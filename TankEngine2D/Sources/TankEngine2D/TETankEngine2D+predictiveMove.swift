...
public extension TETankEngine2D {
    ...
    func predictiveMove(sceneNode: TESceneNode2D, newLocalPosition: SIMD2<Float>) -> TEPredictiveMoveResult {
    ...
    func predictiveMove(sceneNode: TESceneNode2D, localDelta: SIMD2<Float>) -> TEPredictiveMoveResult {
        let candidate = TETransform2D(sceneNode.transform)
    ...
    func predictiveRotate(sceneNode: TESceneNode2D, newLocalRotation angleCW: Angle) -> TEPredictiveMoveResult {
        let candidate = TETransform2D(sceneNode.transform)
    ...
    func predictiveRotate(sceneNode: TESceneNode2D, localDeltaRotation angleCW: Angle) -> TEPredictiveMoveResult {
        let candidate = TETransform2D(sceneNode.transform)
    ...
    func predictiveMove(sceneNode: TESceneNode2D, newLocalTransform: TETransform2D) -> TEPredictiveMoveResult {
    ...
    func predictiveMove(sceneNode: TESceneNode2D, newWorldPosition: SIMD2<Float>) -> TEPredictiveMoveResult {
    ...
    func predictiveMove(sceneNode: TESceneNode2D, worldDelta: SIMD2<Float>) -> TEPredictiveMoveResult {
        let candidate = TETransform2D(sceneNode.worldTransform)
